import { EVENT_TYPE_ICONS } from "./eventTypes";
...
export function buildDigestEmail({ reminders, events, appUrl }) {
  ...
  const eventRows = events.length
    ? events
      ...
      <tr>
        <td style="padding:10px 0;border-bottom:1px solid #eef0f8;">
          <div style="font-weight:600;color:#1c2140;">${EVENT_TYPE_ICONS[e.event_type] ? `${EVENT_TYPE_ICONS[e.event_type]} ` : ""}${escapeHtml(e.title)}</div>
